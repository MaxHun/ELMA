#ifndef FEATURE_WANG_LANDAU_NEXT_NEIGHBOR_AdaptiveWindow_SimulationRun_H
#define FEATURE_WANG_LANDAU_NEXT_NEIGHBOR_AdaptiveWindow_SimulationRun_H
...
class FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun:public Feature
{
public:
	...
	FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun()
	...
	virtual ~FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun(){}
	...
	const double getInternalEnergyWithoutCalculation() const
	{
		return Energy;
	}
...
template<class IngredientsType>
bool FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::checkMove(const IngredientsType& ingredients,
							 const MoveLocalBcc& move) const
{
  //throw exception in case someone accidentaly uses a bcc-BFM move with this feature
  std::stringstream errormessage;
  errormessage<<"FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun::checkMove(...):\n";
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
void FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::applyMove(const IngredientsType& ing,
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
bool FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::checkMove(const IngredientsType& ingredients, const MoveBase& move) const
{
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
bool FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::checkMove(const IngredientsType& ingredients, MoveLocalSc& move)
{
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
void FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::applyMove(IngredientsType& ingredients, const MoveLocalSc& move)
{
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
void FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::synchronize(IngredientsType& ingredients)
{
	...
	std::cout << "Synchronize FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun -> E = " << Energy << std::endl;
}
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
void FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::fillLattice(IngredientsType& ingredients)
{
 ...
 **/
template<template<typename> class LatticeClassType>
inline double FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::getProbabilityFactor(int32_t typeA,
									     int32_t typeB) const
{
#ifdef DEBUG
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
double FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::calculateAcceptanceProbability(
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
double FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::calculateInteractionDifference(
    const IngredientsType& ingredients,
    const MoveLocalSc& move) const
{
 ...
 **/
template<template<typename> class LatticeClassType>
void FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::setNNInteraction(int32_t typeA,
								     int32_t typeB,
								     double energy)
{
	...
	std::cout<<typeA<<" and "<<typeB<<" to "<<energy<<"kT\n";
      ...
      {
	std::stringstream errormessage;
	errormessage<<"FeatureWangLandauNextNeighborAdaptiveWindowSimulationRunFeatureNNInteractionSc::setNNInteraction(typeA,typeB,energy).\n";
 ...
 **/
template<template<typename> class LatticeClassType>
double FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::getNNInteraction(int32_t typeA,
								       int32_t typeB) const
{
  ...
  if(typeA<0 || typeA>255 || typeB<0 || typeB>255){
    std::stringstream errormessage;
    errormessage<<"***FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun::setNNInteraction(typeA,typeB)***\n";
    errormessage<<"typeA "<<typeA<<" typeB "<<typeB<<": Types out of range\n";
    errormessage<<"types are out of the allowed range";
    throw std::runtime_error(errormessage.str());
  }
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
double FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::getInternalEnergy(const IngredientsType& ingredients,size_t index, VectorInt3 direction) const
{
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
double FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::getInternalEnergyCurrentConfiguration(const IngredientsType& ingredients) const
{
	std::vector<VectorInt3> contactSites;
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
double  FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::getInternalEnergyDifference(const IngredientsType& ingredients,size_t index,VectorInt3 direction) const
{
	std::vector<VectorInt3> contactSites;
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
void FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::exportRead(FileImport< IngredientsType >& fileReader)
{
  typedef FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType> my_type;
...
template<template<typename> class LatticeClassType>
template<class IngredientsType>
void FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType>::exportWrite(AnalyzerWriteBfmFile< IngredientsType >& fileWriter) const
{
  typedef FeatureWangLandauNextNeighborAdaptiveWindowSimulationRun<LatticeClassType> my_type;
